      ...
      <Container style={container}>
        ...
        <Section style={body}>
          ...
          <Text style={body__text}>
            We’ve received your request to change your email address. Please enter the following
            code to verify your new email address:
          </Text>

          <Text style={body__code}>398737</Text>
        </Section>
