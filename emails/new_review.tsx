      ...
      <Container style={container}>
        ...
        <Section style={body}>
          ...
          <Text style={body__text}>
            “Random Company Name” has received a new review. To view the contents of the review,
            click here:
          </Text>

          <Button href="https://greenertides.4-com.pro/community-reviews" style={body__button}>
            View a review
          </Button>
        </Section>
